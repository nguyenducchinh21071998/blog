...
Route::get('/class-room/detail/{id}', 'ClassRoomController@detail');
...
Route::get('/get-unit-by-class-room/{id}', 'ClassRoomUnitController@getUnitBy');
...
Route::get('/detail/unit/{id}', 'ClassRoomUnitController@index');
